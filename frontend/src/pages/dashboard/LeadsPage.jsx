...
import { getAllLeads, createLead, updateLead, deleteLead, createCustomer, updateLeadStatus, getLeadHistory, getUser, getAllUsers } from '../../services/api';
...
export default function LeadsPage() {
    ...
    useEffect(() => {
        ...
        if (viewId && leads.length > 0) {
            const leadToView = leads.find(l => l.id === parseInt(viewId));
            if (leadToView) {
                openViewModal(leadToView);
        ...
        const fetchUsers = async () => {
            if (user && (user.roles.includes('ROLE_ADMIN') || user.roles.includes('ROLE_MARKETING') || user.roles.includes('ROLE_SALES'))) {
                try {
                    ...
                    // Filter for users who have ROLE_SALES
                    ...
                    <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="status" value={form.status} onChange={handleChange}
                                        ...
                                        <option value="NURTURING">Nurturing (Future)</option>
                            ...
                            <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-100 dark:border-gray-800">
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Lead Assignment</label>
                                ...
                                {(user.roles.includes('ROLE_ADMIN') || user.roles.includes('ROLE_MARKETING')) ? (
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex flex-col gap-2">
                                            ...
                                            {(!form.assignedTo || form.assignedTo === user.id) && isEditing && leads.find(l => l.id === selectedLeadId)?.assignedTo === user.id && (
                                        ...
                                        {form.assignedTo && form.assignedTo !== user.id && (
                                            <div>
                                                ...
                                                {isEditing && form.assignedTo === leads.find(l => l.id === selectedLeadId)?.assignedTo && (
